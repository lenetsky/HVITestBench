...
def main():
	...
	try:
		...
		module_descriptors = [
			...
			# {'model_number': 'M3201A', 'chassis_number': 1, 'slot_number': 4, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 1, 'slot_number': 8, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 1, 'slot_number': 16, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 2, 'slot_number': 13, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 2, 'slot_number': 17, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 3, 'slot_number': 4, 'options': options },
			# {'model_number': 'M3201A', 'chassis_number': 3, 'slot_number': 15, 'options': options }
			#{'model_number': 'M3201A', 'chassis_number': 4, 'slot_number': 8, 'options': options }
		]
		...
		# Add squid boards
		# TODO - commented out for single chassis
		...
		#Create a list of possible actions for 
